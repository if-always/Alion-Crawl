...
# update： 2017-12-09
# 【日志模块】
# feature: 提供日志记录功能的模块，与python自带的logging兼容，但是不要调用logging里的basicConfig方法，否则会影响此模块的使用
...
class LoggerWrapper(object):
    """
    best practice是不适用logging模块，仅使用本模块，导入logutil后，像使用logging.info等一样使用logutil.info等5个方法
    如果需要修改log_level，调用logutil.set_log_level，如果需要存入log文件，调用logutil.set_logger_storage_file方法
